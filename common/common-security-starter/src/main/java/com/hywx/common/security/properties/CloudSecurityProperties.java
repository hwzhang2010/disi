package com.hywx.common.security.properties;

import com.hywx.common.security.constant.EndpointConstant;
import org.springframework.boot.context.properties.ConfigurationProperties;

/**
 * @author MrBird
 */
@ConfigurationProperties(prefix = "hywx.cloud.security")
public class CloudSecurityProperties {
    ...
    public String toString() {
        return "hywxCloudSecurityProperties{" +
                "enable=" + enable +
                ", authUri='" + authUri + '\'' +
                ", anonUris='" + anonUris + '\'' +
