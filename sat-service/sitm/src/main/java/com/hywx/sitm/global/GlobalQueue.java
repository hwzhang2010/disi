...
public class GlobalQueue {
	...
	//数据存储队列
	private static LinkedBlockingQueue<SitmSave> saveQueue;
	public static LinkedBlockingQueue<SitmSave> getSaveQueue() {
		if (saveQueue == null)
			saveQueue = new LinkedBlockingQueue<SitmSave>(QUEUE_SIZE);
		return saveQueue;
	}
