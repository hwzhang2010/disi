...
public class SitmSender {
	...
	public SitmSender(String host, int port) {
		this.host = host;
		this.port = port;
	...
	public SitmSender(String host, int port, String local) {
		this.host = host;
		this.port = port;
	...
	public void send(byte[] data) {
		try {
			...
			//System.out.println("****************udp multicast send:" + ByteUtil.toHex(data, 0, 6));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
