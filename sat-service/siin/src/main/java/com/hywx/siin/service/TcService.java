...
public interface TcService {
	...
	// 分页查询遥控指令
	Page listTcsByPage(String satelliteId, String groundStationId, String start, String end, Integer currentPage, int pageSize);
	...
	// 分页查询数据注入
	Page listInjectionsByPage(String satelliteId, String groundStationId, String start, String end, Integer currentPage, int pageSize);
