...
public class GroundStationFollow {
	private String epoch;
	private double azimuth;
	private double elevation;
	
	public GroundStationFollow() {
	}

	public GroundStationFollow(Date epoch, double azimuth, double elevation) {
		// 时间格式
	...
	public String toString() {
		return "GroundStationFollow: {epoch=" + epoch + ", azimuth=" + azimuth + ", elevation=" + elevation + "}";
	}
