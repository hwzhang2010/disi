...
public class FaultVO {
	...
	public FaultVO(String satelliteId, String groundStationId, Integer deviceId, Fault fault, Integer level) {
		this.satelliteId = satelliteId;
		this.groundStationId = groundStationId;
		this.deviceId = deviceId;
		this.mainId = fault.getMainId();
		this.subId = fault.getSubId();
		this.level = level;
	}
