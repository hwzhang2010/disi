...
public class GroundStationPassVO {
	...
	public GroundStationPassVO() {
	}

	public GroundStationPassVO(String startTime, String endTime, double duration, int aosAzimuth, double maxElevation, int losAzimuth) {
	...
	public GroundStationPassVO(SatPassTime satPassTime) {
	...
	public String toString() {
		return "GroundStationPassVO: {startTime=" + startTime + ", endTime=" + endTime + ", duration=" + duration
