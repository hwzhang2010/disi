...
import com.hywx.authservice.mapper.OAuthClientDetailsMapper;
...
public class OAuthClientDetailsServiceImpl extends ServiceImpl<OAuthClientDetailsMapper, OAuthClientDetails> implements OAuthClientDetailsService {
   ...
   private PasswordEncoder passwordEncoder;
    ...
    @Override
    public IPage<OAuthClientDetails> getListByPage(QueryRequest request, OAuthClientDetails oauthClientDetails) {
        ...
        if (StringUtils.isNotBlank(oauthClientDetails.getClientId())) {
           // queryWrapper.eq(OAuthClientDetails::getClientId, oauthClientDetails.getClientId());
            queryWrapper.like(OAuthClientDetails::getClientId, oauthClientDetails.getClientId());
        }
        Page<OAuthClientDetails> page = new Page<>(request.getPageNo(), request.getPageSize());
